...
[h: defineFunction("mod.configure", "Configure@lib:w1.lmod", 1)]

[h: '<!-- Auto-generated definitions -->']
[h: '<!-- please ensure the namespace is right -->']
[h: NAMESPACE = "lib:w1.lmod"]
...
[h: defineFunction("effect.remove", strformat("effect.remove@%{NAMESPACE}"), 1)]
[h: defineFunction("effect.ui.manage", strformat("effect.ui.manage@%{NAMESPACE}"), 1)]
[h: defineFunction("json.getSafe", strformat("json.getSafe@%{NAMESPACE}"), 1)]
...
[h: defineFunction("mod.ui.bindScores", strformat("mod.ui.bindScores@%{NAMESPACE}"), 1)]
